...
MASTER_VERSION = 31
GAME_VERSION = 3  # should we change to 5? prevent 0.75/76 sillies from joining
SEMI_WEAPON, SMG_WEAPON, SHOTGUN_WEAPON, RPG_WEAPON = xrange(4)
RIFLE_WEAPON = SEMI_WEAPON  # compat purposes
TORSO, HEAD, ARMS, LEGS, MELEE = xrange(5)
SPADE_TOOL, BLOCK_TOOL, WEAPON_TOOL, GRENADE_TOOL, RPG_TOOL = xrange(5)
...
WEAPON_KILL, HEADSHOT_KILL, MELEE_KILL, GRENADE_KILL, FALL_KILL, TEAM_CHANGE_KILL, CLASS_CHANGE_KILL = xrange(7)
ERROR_UNDEFINED, ERROR_BANNED, ERROR_KICKED, ERROR_WRONG_VERSION, ERROR_FULL = xrange(5)
...
FLAG, BASE, HELICOPTER, AMMO_CRATE, HEALTH_CRATE = xrange(5)
SET_STATE, SET_POSITION, SET_CARRIER = xrange(3)
DAMAGE_SELF, DAMAGE_OTHER, HEAL = xrange(3)
